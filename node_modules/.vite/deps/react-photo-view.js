...
function U(t2) {
  ...
  var We, Se, Te, Ve, Re, Ae, Ie, He, Le = (Re = function(e2) {
    ...
    !function(e3, n3) {
      ...
      if (c4 && !X3 && (X3 = true, m3 ? F(r4, u3, He.X) : H(u3, r4 + (r4 - u3), He.X)), s4 && !N3 && (N3 = true, w3 ? F(i3, d4, He.Y) : H(d4, i3 + (i3 - d4), He.Y)), X3 && N3)
        return false;
      ...
      return (0, import_react.useEffect)(function() {
        if (h3.current || (h3.current = Date.now()), r4) {
          if (function(e4, n2) {
            ...
            return Date.now() - h3.current < 250 ? (f4(1), requestAnimationFrame(function() {
...
function J(r2) {
  ...
  k(function() {
    if (ke)
      return Z2({ pause: true, x: pe * -(innerWidth + x) }), void (ye.current = pe);
    Z2(G);
  }, [ke]);
  ...
  function Se(e2, n2, t2, r3) {
    "x" === e2 ? function(e3) {
      if (void 0 !== oe) {
        ...
        Z2({ touched: true, lastCX: e3, x: te, pause: false });
      ...
      if (void 0 !== ae) {
        ...
        Z2({ touched: true, lastCY: e3, bg: ue, minimal: true });
    }(t2, r3);
  }
  function Te(e2, n2) {
